...
<span id="cronograma"><strong>Cronograma de Estudos</strong>

1. [Semana 1](./Semana_01/)  
    • [JavaScript e HTML: desenvolva um jogo e pratique lógica de programação](./Semana_01/01_Logica_de_programacao/)
2. [Semana 2](./Semana_02/)  
    • [Python: começando com a linguagem](./Semana_02/python-introducao/)  
    • [Python: avançando na linguagem](./Semana_02/python-introducao/)  
3. [Semana 3](./Semana_03/)  
    • [Linux Onboarding: usando a CLI de uma forma rápida e prática](./Semana_03/Linux_Onboarding/)  
    • [Python Collections parte 1: listas e tuplas](./Semana_03/Python_Collections/)  
4. [Semana 4](./Semana_04/)  
    • [Linux Onboarding: localizando arquivos e conteúdos](./Semana_04/Linux_Onboarding_II/)  
    • [Python Collections parte 2: conjuntos e dicionários](./Semana_04/Python_Collections_II/)  
5. [Semana 5](./Semana_05/)  
    • [Linux Onboarding: obtendo e tratando informações do sistema](./Semana_05/Linux_onboarding_III/)  
    • [Python e TDD: explorando testes unitários](./Semana_05/Python_TDD/)  
6. [Semana 6](./Semana_06/)  
    • [Linux Onboarding: trabalhe com usuários, permissões e dispositivos](./Semana_06/Git_e_Github_I/)  
    • [Git e Github: controle e compartilhe seu código](./Semana_06/Git_e_Github_II/)  
    • [Git e Github: estratégias de ramificação, Conflitos e Pull Requests](./Semana_06/Linux_Onboarding_III/)  
